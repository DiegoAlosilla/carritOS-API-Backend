...
{
    public class EditBusinessOwnerPage
    {
        ...
        public EditBusinessOwnerPage(string driver)
        {
        ...
        {
            webDriver.Navigate().GoToUrl("http://localhost:8080/BusinessOwner/Edit/" + id);
            Thread.Sleep(MAX_TIME);
        }
    ...
    string _Movil, string _Password, string _City, string _Country)
        ...
        {
            webDriver.FindElement(By.XPath("/html/body/div/div[1]/div/form/div[10]/input")).Click();
            Thread.Sleep(MAX_TIME);
        }
